            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <?= $form->field($model, 'imageTemp')->widget(FileInput::classname(), [
                        'pluginOptions' => [
                            'initialPreview'=>[
                                Yii::$app->homeUrl."images/minutasa/".$model->id."/".$model->minuta,
                            ],
                            'initialPreviewAsData'=>true,
                            'initialPreviewConfig' => [
                                ['type' => 'pdf','caption' => $model->minuta,
                                    'url' => Yii::$app->homeUrl."images/minutasa/".$model->id."/", 'key' => 10, 'downloadUrl'=> false],
                            ],
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <?= $form->field($model, 'imageTemp2')->widget(FileInput::classname(), [
                        'pluginOptions' => [
                            'initialPreview'=>[
                                Yii::$app->homeUrl."images/minutasa/".$model->id."/".$model->lista,
                            ],
                            'initialPreviewConfig' => [
