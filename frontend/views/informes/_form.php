...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <?= $form->field($model, 'actividad_id')->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(\common\models\Actividades::find()->all(),
                            'id', 'desc_actividad'),
                        'options' => ['placeholder' => 'Selecciona una Region', 'id' => 'actividad_id'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ]) ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <?= $form->field($model, 'personas_beneficiadas')->textInput() ?>
                </div>
            </div>
        </div>
