...
class FormatoLoc extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['indice_marginacion' ,'preescolar','primaria','secundaria', 'delegacion_municipal', 'copaci',
                'comisariado', 'vigilancia','agua', 'comite_prospera', 'nombre_presidente', 'domicilio_presidente',
                'contacto_presidente','nombre_integrante', 'domicilio_integrante', 'contacto_integrante',
                'nombre_director', 'domicilio_director', 'contacto_director'], 'string', 'max' => 255],
            [['indentificacion_hogares', 'calidad_vivienda', 'serv_basicos', 'acceso_edu', 'salud', 'seguridad_social',
                'ingresos', 'alimentacion', 'vinculacion', 'acceso_terrestre', 'necesidades'
            ],'string', 'max' => 3000],
